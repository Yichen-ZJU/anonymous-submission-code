...
class DataValveConfig:
    ...
    cluster_path: str = "./data/spectral_clustering_clip+scores_20_3ds_multi_gpu.json"
    image_folder: str = "./data"

    # LLaVA     
    model_name_or_path: str = "./checkpoints/vicuna-7b-v1.5/"
    vision_tower: str = "./checkpoints/clip-vit-large-patch14/"
    ...
    # [ICML Enhancement]       
    loss_type_sand: str = "cvar"          # options: "mean", "cvar"
    loss_type_div: str = "dpp"            # options: "entropy", "dpp"

    # [ICML Enhancement] CVaR/DPP   
    cvar_alpha: float = 0.5               # CVaR       50%
    dpp_epsilon: float = 1e-4             # DPP        
    ema_decay: float = 0.99               # REINFORCE baseline EMA decay

    # [ICML Enhancement] Zero-Shock Handover     
    norm_sand: float = 1.0                # Sand loss      
    norm_div: float = 0.1                 # Diversity loss       (DPP     )
    norm_rl: float = 1.0                  # [2026-01-23   ] RL loss         0.1     1.0
